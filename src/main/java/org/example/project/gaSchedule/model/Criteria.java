...
public class Criteria {
	...
	{
		// kiểm tra sự trùng lặp về phòng học giữa các lớp học
	...
	static boolean[] isOverlappedProfStudentGrp(List<CourseClass>[] slots, CourseClass cc, int numberOfRooms, int timeId)
	{
		...
		// kiểm tra sự chồng chéo các lớp của giáo sư và nhóm sinh viên
